...
/// forever.
///
/// [enabled] controls if shimmer effect is active.
/// When set to false the animation
/// is paused
///
///
/// ## Pro tips:
...
///
/// * use one [Shimmer] to wrap
/// list of [Widget]s instead of a list of many [Shimmer]s
///
@immutable
